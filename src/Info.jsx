...
export default function () {
  ...
  const quote =
    "Mordern devils are not born with horns and large teeth. Instead they are born with the ability to read and understand _________";
        ...
        <div className="card col-sm-4" onClick={increaseCount}>
          ...
          <div className="card-body">
            {showQuetion.count != 4 && showQuetion.count != 5 ? (
              <>
                As a Machine Learning Engineer with a passion for
                problem-solving, I am dedicated to both the design and
                development aspects of a project, from data collection to model
                deployment. I prioritize creating unique machine learning
                models, data pipelines, and algorithms that make the project
                stand out. My focus is on leveraging data-driven solutions that
                improve efficiency, accuracy, and utility.
              </>
            ) : (
              <>
                {quote}
